 ...
 * @author 凛 (RinOrz)
 */
object InstanceMockIdentifiers : Identifiers() {
  @LazyInit val InstanceMock = type(
    CloakNames.fqNameFor("InstanceMock"),
    arguments = listOf(null)
  )

  const val ActualInstance = "actual"
  const val ActualType = "actualType"
  const val Mock = "mock"
}
