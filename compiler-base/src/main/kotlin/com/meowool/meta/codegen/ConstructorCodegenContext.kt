 ...
 * @author 凛 (RinOrz)
 */
abstract class ConstructorCodegenContext(
  pluginContext: IrPluginContext,
  module: IrModuleFragment,
  metaContext: MetaExtension.Context,
  referencedSymbolRemapper: MetaReferencedSymbolRemapper
) : ElementCodegenContext<IrConstructor, IrStatement>(pluginContext, module, metaContext, referencedSymbolRemapper) {
  abstract val constructor: IrConstructor
}
