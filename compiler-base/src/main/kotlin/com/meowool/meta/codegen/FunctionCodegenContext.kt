 ...
 * @author 凛 (RinOrz)
 */
abstract class FunctionCodegenContext(
  pluginContext: IrPluginContext,
  module: IrModuleFragment,
  metaContext: MetaExtension.Context,
  referencedSymbolRemapper: MetaReferencedSymbolRemapper
) : ElementCodegenContext<IrSimpleFunction, IrStatement>(pluginContext, module, metaContext, referencedSymbolRemapper) {
  abstract val function: IrSimpleFunction
}
