 ...
 * @author 凛 (RinOrz)
 */
interface FunctionsSynthesizer : MetaExtension {
  fun getNames(parent: ClassDescriptor): List<Name>
  ...
  interface Scope {
    fun synthesize(
      ...
      descriptor: DescriptorScope.() -> SimpleFunctionDescriptor?
    )
  }
  ...
  class DescriptorScope(
    ...
    val fromSupertypes: List<SimpleFunctionDescriptor>,
  ) : ClassMemberSynthesizerScope() {
    @LazyInit val nameString = name.asString()
  }
}
