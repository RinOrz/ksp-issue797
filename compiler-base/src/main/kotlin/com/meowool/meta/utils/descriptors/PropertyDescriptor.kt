 ...
 * @author 凛 (RinOrz)
 */
fun DeclarationDescriptor.createPropertyDescriptor(
  name: Name,
  type: KotlinType,
  visibility: DescriptorVisibility = DescriptorVisibilities.PUBLIC,
  isVar: Boolean = false,
  isFinal: Boolean = isVar.not(),
...
fun PsiElement?.toVariableDescriptor(context: BindingContext): VariableDescriptor? =
  context[BindingContext.VARIABLE, this]
